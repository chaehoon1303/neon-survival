 ...
 *
 * This is intentionally a lobby authority only: it owns room membership,
 * readiness and start approval.  The combat simulation protocol will be added
 * separately so a partially implemented server never pretends to synchronize
 * an actual battle.
 */
const MAX_PLAYERS = 5;
