...
(function () {
  ...
  var CODEX = {
    characters: { label: '캐릭터', entries: function () { return Object.entries(CHARACTER_DATA).map(function (entry) { return { id: entry[0], name: entry[1].name, detail: entry[1].role, known: entry[0] === 'recruit' || (typeof operativeIsOwned === 'function' ? operativeIsOwned(entry[0]) : !!operativeRoster[entry[0]]) }; }); } },
  ...
  var ATTENDANCE_REWARDS = [
    { name: '보급 코인', detail: '100 코인', grant: function () { return lobbyCoins(100, '코인 100개'); } },
    { name: '장비 보급', detail: '150 코인', grant: function () { return lobbyCoins(150, '코인 150개'); } },
    { name: '전술 지원', detail: '220 코인', grant: function () { return lobbyCoins(220, '코인 220개'); } },
    ...
    { name: '요원 열쇠', detail: '열쇠 1개', grant: function () { operativeCrateKeys++; saveOperatives(); renderOperativeKeyCount(); return '요원 열쇠 1개 획득'; } },
    { name: '특별 보급', detail: '500 코인 + 열쇠 1개', grant: function () { wallet += 500; localStorage.neonCoins = wallet; renderCoins(); operativeCrateKeys++; saveOperatives(); renderOperativeKeyCount(); return '코인 500개와 요원 열쇠 1개 획득'; } }
  ];
